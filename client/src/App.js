...
function App() {
	...
	return (
		<BrowserRouter>
			<Routes>
				<Route path="/" element={<Create createChatHandler={createChatHandler} createChatRoom={createChatRoom} />}></Route>
				<Route path="/chat" element={<Chat chatInfo={chatInfo} />}></Route>
				<Route path="/invited" element={<Invited invitedHandler={invitedHandler}  invitedRoom={invitedRoom }/>}></Route>
			</Routes>
		</BrowserRouter>
	)
